...
const homeTemplate = (allEvents) => html`
...
<div id="events">
    ...
    ${allEvents.length == 0 ? html`<h4 class="no-event">No Events Yet...</h4>` :
...
`
const singleEvent = (theaterEvent) => html`
<div class="eventsInfo">
            ...
            <div class="info">
                ...
                <div class="info-buttons">
                    <a class="btn-details" href="/details/${theaterEvent._id}">Details</a>
                </div>
            </div>
        </div>`
...
export async function homePage(ctx) {
    console.log(ctx);
    const allEvents = await getAllTheaters();
